...
export const memoryButton = document.getElementById('memory-button');
export const memoryModal = document.getElementById('memory-modal');
export const memoryList = document.getElementById('memory-list');
export const memoryCloseButton = document.getElementById('memory-close');
